<div class="page-title">
    ...
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1" >
            ...
            <li class="active">
                <a href="extra-gallery.html">Update Office</a>
            </li>
        </ol>
    </div>
</div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <h4>Update Office Informations</h4>
    </div>
    <div class="panel-body">
        <form action="" method="POST">
            ...
            <input type="submit" name="save_office" id="save_office" value="Update Office Info" class="btn btn-primary">
